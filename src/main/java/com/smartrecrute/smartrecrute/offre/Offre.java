...
public class Offre {
    ...
    public Offre(String titre, String description, TypeContrat typeContrat, String departement,
                String localisation, NiveauExperience experienceRequise, String avantages,
                Double scoreMinimum, Integer nbCandidatsMax, LocalDateTime dateCloture,
                LocalDateTime datePublication, StatutOffre statut, Recruteur recruteur) {
        this.titre = titre;
        ...
        this.nbCandidatsMax = nbCandidatsMax;
